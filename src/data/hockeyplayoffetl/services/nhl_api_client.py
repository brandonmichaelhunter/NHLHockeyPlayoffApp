    ...
    def fetch_nhl_data(self, endpoint: str):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch NHL API data. Status code: {response.status_code}"
                )
    ...
    def get_teams_info(self):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch teams info. Status code: {response.status_code}"
                )
        except Exception as e:
    ...
    def get_team_roster(self, team_abbrv: str):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch team roster for {team_abbrv}. Status code: {response.status_code}"
                )
        except Exception as e:
            raise Exception(
                f"An error occurred while fetching team roster for {team_abbrv}: {e}"
            )
    ...
    def get_player_info(self, player_id: any):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch player info for player ID {player_id}. Status code: {response.status_code}"
                )
        except Exception as e:
            raise Exception(
                f"An error occurred while fetching player info for player ID {player_id}: {e}"
            )
    ...
    def get_game_boxscore(self, player: any, season: any, game_type: any):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch game boxscore for player ID {player} in season {season} and game type {game_type}. Status code: {response.status_code}"
                )
        except Exception as e:
            raise Exception(
                f"An error occurred while fetching game boxscore for player ID {player} in season {season} and game type {game_type}: {e}"
            )
    ...
    def get_seasons(self):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch seasons. Status code: {response.status_code}"
                )
        except Exception as e:
    ...
    def get_game_info(self):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch game info. Status code: {response.status_code}"
                )
        except Exception as e:
    ...
    def get_game_boxscore_by_game_id(self, game_id: any):
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(
                    f"Failed to fetch game boxscore for game ID {game_id}. Status code: {response.status_code}"
                )
        except Exception as e:
            raise Exception(
                f"An error occurred while fetching game boxscore for game ID {game_id}: {e}"
            )
